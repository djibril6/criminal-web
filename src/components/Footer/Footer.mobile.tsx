...
const useStyles = makeStyles((theme: Theme) => ({
  root: {
    position: (props: any) => (props.isMobile ? 'relative' : 'absolute'),
    bottom: (props: any) => (props.isMobile ? -30 : -1000),
    left: 0,
    width: (props: any) => (props.isMobile ? '90%' : '96.8%'),
    minHeight: 300,
        ...
        <Box display="flex" flexDirection="column" width="100%">
          <Box className={styles.footerTopRight}>
            ...
            <nav
              style={{
                paddingTop: 10,
                borderTop: `1px solid ${customTheme.color.darkGrey}`,
              }}
            >
              <Box
                display="flex"
